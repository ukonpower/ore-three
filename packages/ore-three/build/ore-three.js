...
class AnimationAction extends (wolfy87_eventemitter__WEBPACK_IMPORTED_MODULE_1___default()) {
    constructor(name) {
        super();
        this.curves = {};
        this.name = name || '';
